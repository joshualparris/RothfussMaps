...
Tasks:
1. Search lawful book PDFs if present, evidence ledgers, manifest, building brief, reconstruction brief, existing floorplan JSON, and relevant prompts.
...
4. Flag unsupported or over-assertive claims currently present in prompts or JSON.
...
Rules:
- stop at review gates if evidence is thin or contradictory
