Create a top-down room plan for Admissions Theatre in Hollows as a canon-constrained reconstruction.

Known constraints:
- Empty theatre-like room
- Raised crescent-shaped masters' table in dark room
- Lit mainly around the table
- Used for formal admissions process
- Reinforces authority with elevated staging
- Dark atmosphere for ceremonial function
