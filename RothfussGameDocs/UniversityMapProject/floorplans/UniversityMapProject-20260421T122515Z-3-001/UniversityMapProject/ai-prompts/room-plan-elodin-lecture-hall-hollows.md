Create a top-down room plan for Elodin's Lecture Hall in Hollows as a canon-constrained reconstruction.

Known constraints:
- Huge empty lecture hall
- Entered from hallway above
- Students walk down stairs to front row
- Large slate at front
- Empty and spacious design
- Part of admissions/ceremonial building

Building/floor context:
- Ground floor of simple square stone building with stained glass windows
- Contains admissions theatre, Elodin's office, lecture hall
- Has back entrance with locks for internal partitioning
- Reached from Archives by going "down, then left"
- Identified by colored windows and two big maples outside
