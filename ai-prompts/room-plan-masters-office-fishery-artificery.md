Create a top-down room plan for Master's Office in Fishery/Artificery as a canon-constrained reconstruction.

Known constraints:
- Office for artificery master
- Contains forge
- Private office space in workshop building
- Part of industrial complex with craft shops
- Southern exit and eastern windows

Building/floor context:
- Ground floor of workshop building with specialized equipment
- Contains artificery workshop spaces and master's office
- Located near or adjacent to Fishery
- Has exit to roof for ventilation/emergency
- Industrial workshop architecture with safety considerations
