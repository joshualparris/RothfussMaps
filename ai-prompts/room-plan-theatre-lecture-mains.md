Create a top-down room plan for Theatre-Style Lecture Room in The Mains as a canon-constrained reconstruction.

Known constraints:
- Tiered semicircular seating around raised stages
- Stone worktables on raised stages
- Theatre-like classroom design
- Part of accreted complex with maze-like circulation
- Used for academic instruction

Building/floor context:
- Ground floor of sprawling irregular complex covering nearly 1.5 acres
- Maze-like circulation with odd turns, dead ends, rambling routes, shortcuts
- Contains theatre-style lecture rooms with tiered seating
- Absorbed courtyards and workrooms creating irregular zones
- Oldest University building grown slowly in all directions
